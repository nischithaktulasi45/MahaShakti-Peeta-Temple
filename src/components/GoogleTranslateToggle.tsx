...
export default function GoogleTranslateToggle({ embedded = false }: { embedded?: boolean }) {
  ...
  return (
    <>
      ...
      <div translate="no" className={`notranslate z-[50] flex max-w-[calc(100vw-1rem)] flex-wrap items-center justify-end rounded-full border border-[#D4AF37]/40 bg-white/95 p-1 shadow-lg backdrop-blur ${embedded ? "absolute right-2 top-full mt-2 sm:right-5" : "fixed right-2 top-24 sm:right-6 sm:top-36"}`}>
        <button
          type="button"
          translate="no"
